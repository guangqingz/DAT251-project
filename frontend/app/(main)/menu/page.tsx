...
export default function Page() {
    const menuPdfUrl = `http://localhost:8080/menu/menu-NO-2025.pdf?v=${Date.now()}`;
    const takeawayPdfUrl = `http://localhost:8080/menu/takeaway-2025.pdf?v=${Date.now()}`;
            ...
            <Container style={"flex flex-col items-center h-full justify-center gap-10"}>
                ...
                <div className={"flex flex-col gap-5 text-center lg:text-xl font-title z-10"}>
                    <a
                        ...
                        className={"default-btn bg-custom-red border-custom-red text-white hover:bg-custom-eggwhite hover:text-custom-red"}
                    >
                        Meny
                    </a>
