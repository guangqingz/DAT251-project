...
import {ArrowRightOnRectangleIcon, CalendarDaysIcon, Squares2X2Icon,} from "@heroicons/react/24/outline";
        ...
        <aside className="w-60 bg-[#8B2E1A] rounded-r-2xl text-white flex flex-col justify-between py-6">
            <div>
                ...
                <nav className="flex flex-col">
                    <Link href="/dashboard"
                          className="flex items-center gap-4 px-6 py-4 tracking-widest opacity-100 hover:bg-[#B25533] transition-colors duration-200">
            ...
            <Link href="/login"
                  className="flex items-center gap-3 px-6 py-3 opacity-100  hover:bg-[#B25533] transition-colors duration-200"
                  onClick={() => logout()}>
